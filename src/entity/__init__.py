...
TRANSFORMATION_TRAIN_DATA_FILE = "transform_train_data.csv"
TRANSFORMATION_TEST_DATA_FILE = "transform_test_data.csv"
TRANSFORMATION_VALIDATION_DATA_FILE = "transform_validation_data.csv"
